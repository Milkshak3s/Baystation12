/datum/job/liaison
	...
	total_positions = 1
	spawn_positions = 1
	supervisors = "Corporate Regulations, the Union Charter, and the IISS Torch Board of Directors"
...
/datum/job/bodyguard/get_description_blurb()
	return "You are the Loss Prevention Associate. You are an employee of one of the corporations that make up the IISS Torch Board of Directors, and your job is to prevent the loss of the Liason's life - even at the cost of your own. Good luck."
