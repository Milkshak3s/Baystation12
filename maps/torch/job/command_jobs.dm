/datum/job/captain
	...
	supervisors = "the Third Imperium Government and the Imperial Code of Uniform Justice"
...
/datum/job/representative
	title = "Imperium Representative"
	department = "Support"
	department_flag = SPT
	total_positions = 1
	spawn_positions = 1
	supervisors = "the Imperium Government and the IISS"
...
/datum/job/representative/get_description_blurb()
	return "You are the Third Imperium Representative. You are a civilian assigned as both a diplomatic liaison for first contact and foreign affair situations on board. You are also responsible for monitoring for any serious missteps of justice, imperial law or other ethical or legal issues aboard and informing and advising the Commanding Officer of them. You are a mid-level bureaucrat. You liaise between the crew and corporate interests on board. Send faxes back to Capital on mission progress and important events."
