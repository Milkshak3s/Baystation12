/obj/item/weapon/book/manual/solgov_law
	name = "Third Imperium Government Law"
	desc = "A brief overview of Imperium Law."
	icon_state = "bookSolGovLaw"
	author = "The Third Imperium"
	title = "Third Imperium Government Law"
...
/obj/item/weapon/book/manual/military_law
	name = "The Imperium Code of Military Justice"
	desc = "A brief overview of military law."
	icon_state = "bookSolGovLaw"
	author = "The Third Imperium"
	title = "The Imperium Code of Military Justice"
...
/obj/item/weapon/book/manual/sol_sop
	...
	desc = "SOP aboard the IISS Torch."
...
/obj/item/weapon/folder/envelope/captain/LateInitialize()
	...
	<h3>IMPERIAL INTERSTELLAR SCOUT SERVICE - EXPEDITIONARY COMMAND</h3>
	<img src = sollogo.png>
	</center>
	<b>FROM:</b> ADM William Lau<br>
	<b>TO:</b> Commanding Officer of IISS Torch<br>
	...
	None of these systems are claimed by any entity recognized by the Imperium, so you have full salvage rights on any derelicts discovered.<br>
	Investigate and mark any prospective colony worlds as per usual procedures.<br>
	There is no Imperium presence in that area. In case of distress calls, you will be the only vessel available; do not ignore them. We cannot afford any more PR backlash.<br>
...
/obj/item/weapon/folder/envelope/rep
	desc = "A thick envelope. The Third Imperium crest is stamped in the corner, along with 'TOP SECRET - UMBRA'."
...
/obj/item/weapon/paper/umbra
	...
	<h3>OFFICE OF THE SECRETARY GENERAL OF THE THIRD IMPERIUM</h3>
	<img src = sollogo.png>
	</center>
	<b>FROM:</b> Johnathan Smitherson, Special Aide of the Secretary General<br>
	<b>TO:</b> Commanding Officer of the IISS Torch<br>
	<b>CC:</b> Special Representative aboard the IISS Torch<br>
	...
	Procedure can be initiated only by transmission from IISS Expeditionary Command via secure channel. The sender may not introduce themselves, but you shouldn't have trouble confirming the transmission source, I believe.<br>
	...
	<li>Information about this expedition's findings is to be treated as secret and vital to Imperium's national security, and is protected under codeword UMBRA. Only IM government employees and Skrell citizens aboard the IISS Torch are allowed access to this information on a need-to-know basis.</li>
	...
	<i>Regards, John.</i></tt>
	<i>This paper has been stamped with the stamp of Office of the General Secretary of The Third Imperium.</i>
	"}