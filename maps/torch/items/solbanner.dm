/obj/structure/solbanner
	name = "\improper IM banner"
	icon = 'maps/torch/icons/obj/solbanner.dmi'
	icon_state = "wood"
	desc = "A wooden pole bearing a banner of The Third Imperium. Ave."
	anchored = 1
	obj_flags = OBJ_FLAG_ANCHORABLE
	layer = ABOVE_HUMAN_LAYER

/obj/structure/solbanner/exo
	name = "exoplanet IM banner"
	desc = "A rugged metal frame with a banner of The Third Imperium on it. Resistant to radiation bleaching."
	icon_state = "steel"
	obj_flags = 0
	var/plantedby
...
/obj/item/solbanner
	name = "\improper IM banner capsule"
	desc = "Imperium banner packed in a rapid deployment capsule. Used for staking claims on new worlds in the name of The Third Imperium."
